...
(function() {
    ...
    function renderProfile() {
        const { name, bio, avatar } = CONFIG.profile;

        document.getElementById('name').textContent = name;
        document.getElementById('bio').textContent = bio;
        document.title = `${name} | LinkHub`;
    ...
    function renderLinks() {
        ...
        CONFIG.links.forEach(link => {
            ...
            if (link.icon) {
                card.innerHTML = `<span class="link-icon">${link.icon}</span>${link.title}`;
            } else {
    ...
    // Analytics (optional - tracks clicks)
    document.addEventListener('click', (e) => {
        const link = e.target.closest('.link-card, .social-icon');
        if (link) {
